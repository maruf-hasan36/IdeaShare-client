    ...
    <section className="w-full py-16 px-4 bg-[#f3f6ff] flex justify-center items-center overflow-hidden">
      ...
      >
        ...
        <p className="text-sm sm:text-base text-purple-100/90 max-w-2xl font-light leading-relaxed mb-8">
          Your experiences have shaped you. Now let them shape someone else.
          Join thousands of contributors today.
        </p>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 w-full sm:w-auto">
          ...
          >
            <Link
              href={"/auth/signup"}
              className="block text-center w-full sm:w-auto px-7 py-3 rounded-xl font-bold text-sm text-purple-700 bg-white hover:bg-purple-50 transition-colors shadow-md"
            >
              Start Sharing Free
            </Link>
          </motion.div>
